...
---
*Generated by Go Template Claude Code Hooks*
EOF
...
main() {
    ...
    local notification_title="Go Template: Session Complete"
...
Report: $(basename "$report_file")"
    ...
    if [[ ${checks_failed:-0} -gt 0 ]]; then
        ...
        notification_title="Go Template: Session Complete (Issues Found)"
    fi
